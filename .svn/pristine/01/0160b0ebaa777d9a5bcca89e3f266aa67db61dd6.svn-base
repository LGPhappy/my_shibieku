...
public final class ViewfinderView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        Zzlog.out(TAG, "directtion = " + directtion);
        ...
        if (directtion == 0 || directtion == 2) {
            ...
            if (idcardType == 3000) {
                 ...
                 * 这个矩形就是中间显示的那个框框
                 */
                frame = new Rect((int) (width * 0.15), height / 3, (int) (width * 0.8), (2 * height) / 3);
            } else if (idcardType == 2 || idcardType == 22 || idcardType == 1030 || idcardType == 1031
                    || idcardType == 1032 || idcardType == 1005 || idcardType == 1001 || idcardType == 2001
                    || idcardType == 2004 || idcardType == 2002 || idcardType == 2003 || idcardType == 14
                    || idcardType == 15) {

                frame = new Rect((int) (width * 0.20), (int) (height - 0.41004673 * width) / 2, (int) (width * 0.85),
            ...
            // || idcardType == 10)
                ...
                // for page
                frame = new Rect((int) (width * 0.15), (int) (height - 0.48 * width) / 2, (int) (width * 0.8),
                        (int) (height + 0.48 * width) / 2);
            }
            ...
            if (idcardType == 3000) {
                canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top, frame.right - FRAME_LINE_WIDTH + 2,
                        frame.top + FRAME_LINE_WIDTH, paint);// 上边
                canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top, frame.left + FRAME_LINE_WIDTH + 2,
                        frame.bottom + FRAME_LINE_WIDTH, paint);// 左边
                canvas.drawRect(frame.right - FRAME_LINE_WIDTH - 2, frame.top, frame.right - FRAME_LINE_WIDTH + 2,
                        frame.bottom + FRAME_LINE_WIDTH, paint);// 右边
                canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.bottom, frame.right - FRAME_LINE_WIDTH + 2,
            ...
            {
                canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top, frame.left + FRAME_LINE_WIDTH - 2 + 50,
                        frame.top + FRAME_LINE_WIDTH, paint);
                canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top, frame.left + FRAME_LINE_WIDTH + 2,
                        frame.top + 50, paint);// 左上角
                canvas.drawRect(frame.right - FRAME_LINE_WIDTH - 2, frame.top, frame.right - FRAME_LINE_WIDTH + 2,
                        frame.top + 50, paint);
                canvas.drawRect(frame.right - FRAME_LINE_WIDTH - 2 - 50, frame.top, frame.right - FRAME_LINE_WIDTH + 2,
                        frame.top + FRAME_LINE_WIDTH, paint);// 右上角
                canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.bottom - 50, frame.left + FRAME_LINE_WIDTH + 2,
                        frame.bottom, paint);
                ...
                canvas.drawRect(frame.right - FRAME_LINE_WIDTH - 2 - 50, frame.bottom - FRAME_LINE_WIDTH,
                        frame.right - FRAME_LINE_WIDTH - 2, frame.bottom, paint); // 右下角
                // 如果检测到证件左边就会画出左边的提示线
                if (checkLeftFrame == 1)
                    canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top, frame.left + FRAME_LINE_WIDTH + 2,
                            frame.bottom, paint);// 左边
                // 如果检测到证件上边就会画出左边的提示线
                if (checkTopFrame == 1)
                    canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top, frame.right - FRAME_LINE_WIDTH + 2,
                            frame.top + FRAME_LINE_WIDTH, paint);// 上边
            ...
            if (width < height) {
                ...
                if (idcardType == 3000) {
                     ...
                     * 这个矩形就是中间显示的那个框框
                     */
                    frame = new Rect((int) (width * 0.2), height / 3, (int) (width * 0.85), 2 * height / 3);
                } else if (idcardType == 2 || idcardType == 22 || idcardType == 1030 || idcardType == 1031
                        || idcardType == 1032 || idcardType == 1005 || idcardType == 1001 || idcardType == 2001
                        || idcardType == 2004 || idcardType == 2002 || idcardType == 2003 || idcardType == 14
                        || idcardType == 15) {

                    frame = new Rect((int) (width * 0.20), (int) (height - width * 0.65 * 54 / 85.6) / 2,
                            (int) (width * 0.85), (int) (height + width * 0.65 * 54 / 85.6) / 2);

                } else if (idcardType == 5 || idcardType == 6) {
                    frame = new Rect((int) (width * 0.22), (int) (height - 0.41004673 * width) / 2,
                            (int) (width * 0.83), (int) (height + 0.41004673 * width) / 2);
                } else
                ...
                {
                    // for page
                    frame = new Rect((int) (width * 0.2), (int) (height - 0.45 * width) / 2, (int) (width * 0.85),
                ...
                // || idcardType == 5 || idcardType == 10)
                {
                    ...
                    canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top,
                            frame.left + FRAME_LINE_WIDTH - 2 + 50, frame.top + FRAME_LINE_WIDTH, paint);
                    canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top, frame.left + FRAME_LINE_WIDTH + 2,
                            frame.top + 50, paint);// 左上角
                    canvas.drawRect(frame.right - FRAME_LINE_WIDTH - 2, frame.top, frame.right - FRAME_LINE_WIDTH + 2,
                            frame.top + 50, paint);
                    canvas.drawRect(frame.right - FRAME_LINE_WIDTH - 2 - 50, frame.top,
                            frame.right - FRAME_LINE_WIDTH + 2, frame.top + FRAME_LINE_WIDTH, paint);// 右上角
                    ...
                    if (checkTopFrame == 1)
                        canvas.drawRect(frame.left + FRAME_LINE_WIDTH - 2, frame.top,
                                frame.right - FRAME_LINE_WIDTH + 2, frame.top + FRAME_LINE_WIDTH, paint);// 上边
                    // 如果检测到证件右边就会画出左边的提示线
                    if (checkRightFrame == 1)
