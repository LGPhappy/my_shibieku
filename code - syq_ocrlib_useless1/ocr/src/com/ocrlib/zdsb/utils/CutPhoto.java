...
public class CutPhoto {
    ...
    public String getCutPhotoPath(Bitmap bitmap, String file_name, String foldPath) {
        ...
        Log.e("", "cut_width=" + cut_width + ";cut_height=" + cut_height + ";cavas_width="
                + cavas_width + ";cavas_height=" + cavas_height);
        resultBitmap = Bitmap.createBitmap(bitmap, startx, starty, cavas_width, cavas_height,
                cut_matrix, true);
