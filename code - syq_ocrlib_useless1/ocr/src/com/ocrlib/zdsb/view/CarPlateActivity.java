...
import com.ocrlib.zdsb.bean.CarPlateBean;
import com.ocrlib.zdsb.utils.Constant;
import com.ocrlib.zdsb.utils.FileUtils;
import com.ocrlib.zdsb.utils.Utils;
import com.ocrlib.zdsb.utils.Zzlog;
import com.ocrlib.zdsb.view.CarResultDialog.IClickListener;
...
public class CarPlateActivity extends Activity
        ...
        if (iInitPlateIDSDK != 0) {
            ...
            if (!TextUtils.isEmpty(boolString)) {
                ...
                if (!TextUtils.isEmpty(firstNumber)) {
                    ...
                    if (isShowDialog) {
                        showResultDialog(color, firstNumber);
                    } else {

                       
                        
                        returnWithData(color, firstNumber);
    ...
    private void returnWithData(String color, String number) {
        ...
        CarPlateBean car = new CarPlateBean();
        car.setColor(color);
    ...
    private void showResultDialog(String color, String firstNumber) {
